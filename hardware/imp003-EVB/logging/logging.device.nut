...
led_red.configure(DIGITAL_OUT_OD);  led_red.write(1);   // RGB active-low
led_grn.configure(DIGITAL_OUT_OD);  led_grn.write(1);
led_blu.configure(DIGITAL_OUT_OD);  led_blu.write(1);
