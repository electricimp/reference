...
// Rocky has been changed in the reference repo. This is the previous version that works with IFTTT.
    ...
    function _onrequest(req, res) {
        ...
        try {
            ...
            try {
                ...
                server.error("Parse error '" + e + "' when parsing:\r\n" + req.body)
                context.send(400, e);
                return;
            }
